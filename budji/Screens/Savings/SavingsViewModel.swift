            ...
            ZStack(alignment: .leading) {
                ...
                VStack(alignment: .leading) {
                    ...
                    HStack{
                        ...
                        Text("$\(String(format:"%.2f",(totalAmount * percentageVar) - savingAmount))")
                            .font(.subheadline)
                            .foregroundColor(.gray)
                    }
...
#Preview {
    SavingsViewModel(savingAmount: .constant(0.0), percentageVar: 0.0, totalAmount: 0.0)
}
