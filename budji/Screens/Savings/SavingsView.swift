...
//                .keyboardType(.decimalPad)
            ...
            HStack {
                ...
                Button {
                    ...
                    FirebaseAuth.shared.saveExpense(with: expense, type: "savings") { success, error in
                        if success {
...
//                    FirebaseAuth.shared.saveSavingExpense(with: expense) { success, error in
//                        if success {
//                            // Handle successful save
//                            showModal = false
//                            print("success")
...
//                    }
        ...
        .sheet(isPresented: $isSheetShown) {
            PresentScreen(segment: $segment,categoryName: $categoryName)
                ...
                .presentationDragIndicator(.visible) // Optional, to show the drag indicato
        }
...
#Preview {
    SavingsView(showModal: .constant(false))
}
